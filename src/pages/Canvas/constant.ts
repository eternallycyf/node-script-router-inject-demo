...
| 函数作用       | 函数名称  | 使用方法             | 其他注释               |
| -------------- | --------- | -------------------- | ---------------------- |
| 初始点         | moveTo    | moveTo(x坐标,y坐标); |                        |
| 移动目标点     | lineTo    | lineTo(x坐标,y坐标); |                        |
...
- arc()
  ...
  - y 圆心纵坐标
  - r 半径
  - startAngle 开始角度     Math.PI  (π) ==180度
  - endAngle 结束角度
...
- ctx.textAlign文本水平对齐方式，相对绘制坐标来说的
  ...
  - start 默认
  - end
- ctx.direction属性css(rtl ltr) start和end于此相关    [右对齐 左对齐]
...
<img width="400px" height="300px" src="images/2.jpg"></img>
获取随机颜色
